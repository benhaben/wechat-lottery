exports.main = (function(e) {
  ...
  function(e, t, _) {
    ...
    const n = {
      ...
      E = { WITHDRAW_CREATE_SUCCESS: "提现申请成功" },
      u = {
  ...
  function(e, t, _) {
    ...
    const r = new wx.BaaS.TableObject(n.g.USER_LOTTERY_RECORD),
      E = new wx.BaaS.TableObject(n.g.LOTTERY),
      u = new wx.BaaS.TableObject(n.g.BALANCE_LUCKY_RECORD),
      a = new wx.BaaS.TableObject(n.g.CONFIG),
      T = new wx.BaaS.User();
  ...
  function(e, t, _) {
    ...
    async function E(e, t) {
      ...
      try {
        const { id: _, status: E } = e.data;
        e.request.user.id;
        if (E !== r.c.REJECTED && E !== r.c.APPROVED)
          throw new Error("status状态错误");
        if ((await n.c.get(_)).data.status !== r.c.WAIT_APPROVE)
          throw new Error("抽奖未支付");
        let u = n.c.getWithoutData(_);
        u.set({ status: E }), t(null, await u.update());
      } catch (e) {
        console.log(e), t(e);
      }
    }
