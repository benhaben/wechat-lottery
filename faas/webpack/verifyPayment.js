exports.main = (function(t) {
  ...
  1: function(t, e, n) {
    ...
    const a = new BaaS.TableObject(r.d.USER_LOTTERY_RECORD),
      ...
      E = new BaaS.TableObject(r.d.WITHDRAW);
    async function T(t) {
  ...
  28: function(t, e, n) {
    ...
    async function o(t, e) {
      ...
      try {
        ...
        if (t && t.total_prize === o * a.b.MONEY_UNIT) {
          let t = r.e.getWithoutData(u);
          t.set("status", a.b.WAIT_APPROVE),
            t.set("transaction_no", _),
            e(null, await t.update());
        } else if (0.01 === o) {
          console.log("测试支付！！！");
          let n = {
            error: `支付金额和抽奖金额不一致：want - ${t.total_prize /
              a.b.MONEY_UNIT} | actual - ${o}`,
            action: "verifyPayment",
            created_by: t.created_by,
            lottery: r.e.getWithoutData(u)
          };
          console.log("测试支付1！！！" + JSON.stringify(n));
          const c = r.d.create();
          await c.set(n).save();
          console.log("测试支付2！！！");
          let i = r.e.getWithoutData(u);
          console.log("测试支付3！！！"),
            i.set("status", a.b.WAIT_APPROVE),
            i.set("transaction_no", _);
          let E = await i.update();
          console.log("测试支付4！！！更新状态到 WAIT_APPROVE"), e(null, E);
        } else {
          let n = {
            error: `支付金额和抽奖金额不一致：want - ${t.total_prize /
              a.b.MONEY_UNIT} | actual - ${o}`,
