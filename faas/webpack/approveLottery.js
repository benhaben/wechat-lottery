exports.main = (function(t) {
  ...
  function(t, e, n) {
    ...
    const u = new BaaS.TableObject(r.d.USER_LOTTERY_RECORD),
      ...
      i = new BaaS.User(),
      E = new BaaS.TableObject(r.d.BALANCE_LUCKY_RECORD);
    async function _(t) {
  ...
  function(t, e, n) {
    ...
    async function o(t, e) {
      ...
      try {
        ...
        if ((await r.d.get(n)).data.status !== u.b.WAIT_APPROVE)
          throw new Error("抽奖未支付");
        let a = r.d.getWithoutData(n);
        a.set({ status: o }), e(null, await a.update());
      } catch (t) {
        console.log(t), e(t);
      }
    }
