exports.main = (function(e) {
  ...
  1: function(e, n, t) {
    ...
    const u = new BaaS.TableObject(r.d.USER_LOTTERY_RECORD),
      _ = new BaaS.TableObject(r.d.LOTTERY),
      T = new BaaS.TableObject(r.d.CONFIG),
      E = new BaaS.TableObject(r.d.ERROR),
      o = new BaaS.User(),
    ...
    async function a(e) {
      ...
      return (
        n.compare("lottery", "=", _.getWithoutData(e)), u.setQuery(n).count()
      );
    }
    async function i() {
  ...
  20: function(e, n, t) {
    ...
    async function _(e, n) {
      ...
      try {
        (t.lucky_num_open =
          t.lucky_num * (r.b.LUCKY_RATIO_SUCCESS / r.b.LUCKY_RATIO_OPEN)),
          (t.created_by = _);
        const e = u.e.create();
        n(null, await e.set(t).save());
      } catch (e) {
        n(e);
      }
    }
