exports.main = (function(e) {
  ...
  16: function(e, t, _) {
    "use strict";
    _.r(t),
      _.d(t, "default", function() {
        return a;
      });
    var n = _(2),
      r = _(0);
    async function a(e, t) {
      const { lottery_id: _, weight: a } = e.data,
        T = e.request.user.id;
      try {
        let e,
          u = a / r.c.ONE_LUCKY_NUM_WEIGHT,
          E = (await n.e.get(T)).data;
        if (
          (0 === u
            ? ((e = `参与抽奖，减少${r.c.ATTEND_LOTTERY_COST}运气值`),
              (u = r.c.ATTEND_LOTTERY_COST))
            : ((e = `参与抽奖，减少${r.c.ATTEND_LOTTERY_COST}运气值，增加权重减少${u}运气值`),
              (u = r.c.ATTEND_LOTTERY_COST + u)),
          E.lucky_num < u)
        )
          throw new Error(r.d.OUT_OF_LUCKY_NUM);
        let o = n.e.getWithoutData(T);
        o.incrementBy("lucky_num", -u), await o.update();
        const s = n.a.create();
        await s
          .set({ reason: e, lucky_num: -u, user_id: T, lottery_id: _ })
          .save();
        let c = n.c.getWithoutData(_);
        const i = n.d.create();
        t(
          null,
          await i
  ...
  2: function(e, t, _) {
    ...
    var n = _(0);
    const r = new wx.BaaS.TableObject(n.g.USER_LOTTERY_RECORD),
      a = new wx.BaaS.TableObject(n.g.LOTTERY),
      T = new wx.BaaS.TableObject(n.g.BALANCE_LUCKY_RECORD),
      u = new wx.BaaS.TableObject(n.g.CONFIG),
      E = new wx.BaaS.User();
    new wx.BaaS.TableObject(n.g.DAILY_CHECKIN),
      new wx.BaaS.TableObject(n.g.QUESTIONS),
      new wx.BaaS.TableObject(n.g.WITHDRAW),
      new wx.BaaS.TableObject(n.g.ADDRESS_BOOK);
  }
}).default;
