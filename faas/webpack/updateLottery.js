exports.main = (function(t) {
  ...
  1: function(t, e, n) {
    ...
    const u = new BaaS.TableObject(r.d.USER_LOTTERY_RECORD),
      ...
      T = new BaaS.TableObject(r.d.WITHDRAW);
    async function i(t) {
  ...
  26: function(t, e, n) {
    ...
    async function o(t, e) {
      ...
      try {
        const { id: n } = t.data;
        let o = t.data,
          _ = (await r.e.get(n)).data;
        if (_.status !== u.b.REJECTED && _.status !== u.b.WAIT_APPROVE)
          throw new Error("status状态错误，lottery.status - ${lottery.status}");
        let a = r.e.getWithoutData(n);
        a.set({
