exports.main = (function(t) {
  ...
  function(t, e, n) {
    ...
    const u = new BaaS.TableObject(r.d.USER_LOTTERY_RECORD),
      ...
      o = new BaaS.TableObject(r.d.ERROR),
      T = new BaaS.User(),
  ...
  function(t, e, n) {
    ...
    async function a(t, e) {
      ...
      try {
        let t,
          o = a / u.b.ONE_LUCKY_NUM_WEIGHT,
          T = await r.h.get(_);
        if (
          (0 === o
            ? ((t = `参与抽奖，减少${u.b.ATTEND_LOTTERY_COST}运气值`),
              (o = u.b.ATTEND_LOTTERY_COST))
            : ((t = `参与抽奖，减少${u.b.ATTEND_LOTTERY_COST}运气值，增加权重减少${o}运气值`),
              (o = u.b.ATTEND_LOTTERY_COST + o)),
          T.lucky_num < o)
        )
          throw new Error(u.c.OUT_OF_LUCKY_NUM);
        let c = r.h.getWithoutData(_);
        c.incrementBy("lucky_num", -o), await c.update();
        const i = r.a.create();
        await i
          .set({ reason: t, lucky_num: -o, user_id: _, lottery_id: n })
          .save();
        let E = r.d.getWithoutData(n);
        const O = r.g.create();
        e(
          null,
          await O.set({
